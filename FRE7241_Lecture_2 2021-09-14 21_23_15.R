...
PerformanceAnalytics::SharpeRatio(re_turns, FUN="ES",
  p=(1-conf_level), method="2historical")
...
re_turns <- rutils::diff_it(price_s)/
  rutils::lag_it(price_s, lagg=1, pad_zeros=FALSE) # percentage returns
...
bid_offer <- 0.001
# Cumulative transaction costs caused from rebalancing fixed dollar amount
